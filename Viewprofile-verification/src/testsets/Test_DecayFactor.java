...
public class Test_DecayFactor {
	...
	public void runTest() {
		...
		System.out.println("(ATTACK_TYPE = "+ATTACK_NAME+", ATTACKER_PECENTAGES = "+percentages+"%)");
		...
		for (decayFactor = 0.7; decayFactor < 0.96; decayFactor = decayFactor + 0.05) {
